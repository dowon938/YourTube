...
const Home = memo(
  ({ authService, dbService, userId, youtube, onPlayer, setPlayer, darkTheme }) => {
        ...
        <div className={styles.home}>
          <div className={styles.tab}>
            ...
            <div className={styles.myTab}>
              ...
              <button
                onClick={addPage}
                className={styles.plusPage}
                style={{
                  backgroundColor: darkTheme ? COLORS.Dgrey1 : COLORS.Lgrey1,
                  color: darkTheme ? COLORS.vWhite : COLORS.vWhite,
                }}
              >
              ...
              <button
                onClick={editPage}
                className={`${styles.editPage} ${editOn}`}
                style={{
                  backgroundColor:
                    (pageEdit && COLORS.mainColorL) ||
                    (darkTheme && COLORS.Dgrey1) ||
                    COLORS.Lgrey1,
                  color: darkTheme ? COLORS.vWhite : COLORS.vWhite,
                }}
              >
